...
let myGif;
const gifURL =
  "https://media2.giphy.com/media/nv5rlmTeT6gUECLhVv/giphy.gif?cid=ecf05e476e1dda117e1525498493a89bd607d7755e19185f&rid=giphy.gif&ct=g";
...
function drawSmoothGif() {
  if (x != 0 || y != 0) {
    ...
    for (let i = 1; i < n + 1; i++) {
      ...
      } else if (myGif.lastFrame !== null) {
        // Shows frames as they load
        ctx.drawImage(
          myGif.lastFrame.image,
          ((coord.x - x) * i) / n + x - imageWidth / 2,
          ((coord.y - y) * i) / n + y - imageHeight / 2,
          imageWidth,
          imageHeight
